...
describe('extractAddressedText', () => {
  ...
  it('escapes regex metacharacters in the bot username', () => {
    expect(extractAddressedText('@nano.bot 1234', 'nano.bot')).toBe('1234');
    expect(extractAddressedText('@nanoXbot 1234', 'nano.bot')).toBeNull();
  });
});
